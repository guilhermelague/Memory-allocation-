 ...
 * Descrição: Implementação do algoritmo Worst-fit, para alocação dinamica de memória.
...
//================================================================================
// Esta função cria um arquivo chamado wf.txt, simulando uma memória com blocos ja determinados
// FILE* file: Ponteiro para o arquivo
//================================================================================
void cria_arquivo(FILE* file){
    file = fopen("C:/Users/Guilherme Lague/Desktop/wf.txt","w+t");
...
//================================================================================
// Esta função le o arquivo criado chamado wf.txt
// FILE* file: Ponteiro para o arquivo
//================================================================================
void le_arquivo(FILE* file){
    int id, tam;
    
    file = fopen("C:/Users/Guilherme Lague/Desktop/wf.txt","rt");
    while(!feof(file)){
...
//================================================================================
// Esta função procura o bloco de maior tamanho para alocar um processo
//================================================================================
int procura_maior_bloco(){
    int aux = 0;
    bloco *mem = inicio_b;
    do{
        if(mem->tam_bloco > aux && mem->id_processo == 0){
            aux = mem->tam_bloco;
        }
        if(mem->prox == inicio_b){
            break;
        }
        mem = mem->prox;
    }while(mem != inicio_b);
...
//================================================================================
// Esta função aloca os processos em Worst-fit
//================================================================================
void worst_fit(){
    int tamanho;
    int id = total_blocos();
    ...
    do{
        novo_b = inicio_b;
        do{
            int x = procura_maior_bloco();
            if(novo_b->tam_bloco == x && novo_b->tam_bloco > novo_p->tam_processo && novo_b->id_processo == 0){
