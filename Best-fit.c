 ...
 * Descrição: Implementação do algoritmo Best-fit, para alocação dinamica de memória.
...
void cria_arquivo(FILE* file){
    file = fopen("C:/Users/Guilherme Lague/Desktop/bf.txt","w+t");
...
void le_arquivo(FILE* file){
    ...
    file = fopen("C:/Users/Guilherme Lague/Desktop/bf.txt","rt");
    while(!feof(file)){
...
//================================================================================
// Esta função procura o bloco com o tamanho mais proximo para ser alocado por um processo
//================================================================================
int procura_melhor_bloco(processo* pro){ 
    int espaco,  aux;
    bloco *mem = inicio_b;
    aux = mem->tam_bloco;
    do{
        espaco = mem->tam_bloco - pro->tam_processo; //diferença
        
        if(espaco == 0 && mem->tam_bloco > pro->tam_processo){
            aux = espaco;
        }else if(espaco <= aux && mem->tam_bloco > pro->tam_processo){
            aux = espaco;
        }
    ...
    int tam = pro->tam_processo + aux;
    return tam;
}

//================================================================================
// Esta função aloca os processos em Best-fit
//================================================================================
void best_fit(){
    int tamanho;
    int id = total_blocos();
    ...
    do{
        novo_b = inicio_b;
        do{
            int x = procura_melhor_bloco(novo_p);
            if(novo_b->tam_bloco == x && novo_b->id_processo == 0){
